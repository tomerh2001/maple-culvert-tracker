...
const truncateSQL = `TRUNCATE characters, character_culvert_scores, weekly_announcements, weekly_screenshot_archives, weekly_screenshot_pages, weekly_recaps RESTART IDENTITY CASCADE`
